...
const i18n = {
  zh: {
    ...
    m_f7_name: '巴西红胡椒排骨滑鸡煲仔饭',
    m_f7_desc: '巴西红胡椒独特香气入髓，排骨滑鸡鲜嫩多汁，层次感爆棚。',
    m_i1_name: '芝士黑松露煲仔饭',
    ...
    m_i7_name: '雪菜牛蹄筋煲仔饭',
    m_i7_desc: '雪菜清脆咸香，牛蹄筋煨至胶质满满，滋味绝妙。',
    m_i8_name: '雪菜春笋煲仔饭',
    m_i8_desc: '春笋清脆、雪菜咸鲜，碰撞出极致山野之鲜，每一口都是清爽的春日滋味。',
    m_i9_name: '姜蓉吊龙咸蛋煲仔饭',
    m_i9_desc: '细腻姜蓉激发吊龙鲜嫩，咸蛋黄沙香出油，拌匀入口，油脂交融。',
    ...
    stores_cta_btn: '联系我们',
    store1_badge: '中国·广州', store1_name: '煲仔宗师南站喜街店', store1_address: '门店地址：中国广州市番禺区南站喜街A6栋二楼', store1_date: '营业时间：10:00-22:00',
    ...
    store5_badge: '中国·广州', store5_name: '煲仔宗师啤酒厂1985店', store5_address: '门店地址：中国广州市海珠琶醍啤酒厂1985', store5_date: '营业时间：筹备中',
    // Contact Info
  ...
  en: {
    ...
    m_f7_name_en: 'Brazilian Red Pepper Spare Rib & Chicken Clay Pot Rice',
    // ── Innovation Series ──
    ...
    m_i7_name_en: 'Pickled Mustard & Beef Tendon Clay Pot Rice',
    m_i8_name_en: 'Pickled Mustard & Spring Bamboo Shoot Clay Pot Rice',
    m_i9_name_en: 'Ginger Diao Long Beef & Salted Egg Clay Pot Rice',
    // ── Dim Sum Series ──
    ...
    m_f7_name: 'Brazilian Red Pepper Spare Rib & Chicken Clay Pot Rice',
    m_f7_desc: 'Brazilian red pepper\'s unique aroma penetrates deep — spare ribs and tender chicken are juicy and succulent, layers of flavor that blow your mind.',
    ...
    m_i7_name: 'Pickled Mustard & Beef Tendon Clay Pot Rice',
    m_i7_desc: 'Crispy pickled mustard meets collagen-rich beef tendon — savory, satisfying, absolutely divine.',
    m_i8_name: 'Pickled Mustard & Spring Bamboo Shoot Clay Pot Rice',
    m_i8_desc: 'Crispy spring bamboo shoots and savory pickled mustard collide for ultimate mountain freshness — every bite is pure spring delight.',
    m_i9_name: 'Ginger Diao Long Beef & Salted Egg Clay Pot Rice',
    m_i9_desc: 'Delicate ginger awakens tender diao long beef, salted egg yolk adds rich, buttery depth — stir it all in for a luscious, flavor-packed bite.',
    ...
    store1_badge: 'China · Guangzhou', store1_name: 'POTMASTER @GUANGZHOU SOUTH STATION HEYBLOCK', store1_address: 'Store Address: Building A6, 2/F, Guangzhou South Station HeyBlock, Panyu, Guangzhou, China', store1_date: 'Business Hours: 10:00-22:00',
    ...
    store5_badge: 'China · Guangzhou', store5_name: 'POTMASTER @PAZHOU BREWERY 1985', store5_address: 'Store Address: Pazhou Brewery 1985, Haizhu District, Guangzhou, China', store5_date: 'Coming Soon',
  ...
  zh_tw: {
    ...
    m_f6_desc: '普寧豆醬激發出銀鱈魚的豐腴，肉質如奶油般如奶油般絲滑，鮮鹹地道。',
    m_f7_name: '巴西紅胡椒排骨滑雞煲仔飯',
    m_f7_desc: '巴西紅胡椒獨特香氣入髓，排骨滑雞鮮嫩多汁，層次感爆棚。',
    // ── 創新系列 ──
    m_i1_name: '芝士黑松露煲仔飯',
    ...
    m_i7_name: '雪菜牛蹄筋煲仔飯',
    m_i7_desc: '雪菜清脆鹹香，牛蹄筋煨至膠質滿滿，滋味絕妙。',
    m_i8_name: '雪菜春筍煲仔飯',
    m_i8_desc: '春筍清脆、雪菜鹹鮮，碰撞出極致山野之鮮，每一口都是清爽的春日滋味。',
    m_i9_name: '薑蓉吊龍鹹蛋煲仔飯',
    m_i9_desc: '細膩薑蓉激發吊龍鮮嫩，鹹蛋黃沙香出油，拌勻入口，油脂交融。',
    // ── 點心系列 ──
    m_d1_name: '招牌蝦餃皇',
    ...
    stores_cta_btn: '聯繫我們',
    store1_badge: '中國·廣州', store1_name: '煲仔宗師南站喜街店', store1_address: '門店地址：中國廣州市番禺區南站喜街A6棟二樓', store1_date: '營業時間：10:00-22:00',
    ...
    store5_badge: '中國·廣州', store5_name: '煲仔宗師啤酒廠1985店', store5_address: '門店地址：中國廣州市海珠琶醍啤酒廠1985', store5_date: '營業時間：籌備中',
    // Contact Info
